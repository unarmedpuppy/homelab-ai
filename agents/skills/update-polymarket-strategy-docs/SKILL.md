---
name: update-polymarket-strategy-docs
...
Read the actual code path and compare to the diagram in `STRATEGY_ARCHITECTURE.md`:
...
In `STRATEGY_ARCHITECTURE.md`, update the Implementation Status section:
...
Compare `strategy-rules.md` rules against actual code:
...
Update the Configuration Reference section in `strategy-rules.md`.

### 5. Update Changelog

Add entry to `strategy-rules.md` changelog:
...
```bash
# Files to update
apps/polymarket-bot/docs/STRATEGY_ARCHITECTURE.md
apps/polymarket-bot/docs/strategy-rules.md

# Files to reference (actual implementation)
apps/polymarket-bot/src/strategies/gabagool.py
apps/polymarket-bot/src/client/polymarket.py
apps/polymarket-bot/src/monitoring/order_book.py
apps/polymarket-bot/src/config.py
```
