...
- **Auth module**: `~/repos/homelab-ai/llm-router/auth.py`
- **Dashboard nginx**: `~/repos/homelab-ai/dashboard/nginx.conf.template`
...
```bash
ssh -p 4242 unarmedpuppy@192.168.86.47 "cd ~/repos/homelab-ai && docker compose -f docker-compose.yml -f docker-compose.server.yml up -d dashboard"
```
