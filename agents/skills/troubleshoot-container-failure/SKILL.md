...
description: Debug why a Docker container won't start or is unhealthy
when_to_use: Container won't start, container crashes or exits, container is unhealthy, service not responding
---
