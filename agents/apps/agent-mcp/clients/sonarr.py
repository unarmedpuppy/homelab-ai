...
class SonarrClient:
    ...
    def __init__(self):
        ...
        self.api_key = settings.get("sonarr", "api_key")
        self.base_url = settings.get("sonarr", "base_url")
        self.container = settings.get("sonarr", "container")
