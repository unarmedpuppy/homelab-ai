...
**Parameters:**
- `output_path` (optional): Output directory (defaults to apps/agent_memory/memory/export/)
...
- **Memory System README**: `apps/agent_memory/README.md` - Memory system details
- **Tool Discovery Guide**: `apps/docs/MCP_TOOL_DISCOVERY.md` - How to discover tools
