    ...
    if (map === null) {
        ...
        map = new ol.Map({
            ...
            view: new ol.View({
                projection: projection,
                center: [
                    dimensionInfo[globalDimensionId].playerPosX + Math.floor(dimensionInfo[globalDimensionId].worldWidth / 125)
                   ,dimensionInfo[globalDimensionId].playerPosY + Math.floor(dimensionInfo[globalDimensionId].worldHeight / 150)
                ],
                resolution: 1
            })
        });
        ...
        var view = new ol.View({
            projection: projection,
            center: [
                dimensionInfo[globalDimensionId].playerPosX + Math.floor(Math.abs(dimensionInfo[globalDimensionId].worldWidth) / 125),
                dimensionInfo[globalDimensionId].playerPosY + Math.floor(Math.abs(dimensionInfo[globalDimensionId].worldHeight) / 150)
            ],
        resolution: 1
        });
        map.setView(view);
